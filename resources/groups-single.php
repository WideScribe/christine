...
<html lang="no-nb" class="scheme_original">
    <head>
        ...
        <title> Forums - Cloe Brooks - Psychologist</title>
        ...
        <!-- style -->
            ...
            <link rel='stylesheet' href='css/skins/less/skin.css' type='text/css' media='all' />
            <link rel='stylesheet' href='css/custom-style.css' type='text/css' media='all' />          
            <link rel='stylesheet' href='css/animations.css' type='text/css' media='all' />
            <link rel="stylesheet" href="js/swiper/swiper.css" type="text/css" media="all">
            <link rel="stylesheet" href="js/bbpress/css/boddypress.css" type="text/css" media="all">     
            <link rel="stylesheet" href="js/bbpress/css/plugin-bbpress.css" type="text/css" media="all">    
        <!-- /style -->
   </head>
    ...
    <body class="single-item groups group-power-of-education group-home home buddypress page page-parent page-template-default cloe_brooks_body body_style_wide body_transparent theme_skin_less article_style_stretch layout_single-standard template_single-standard scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide">
        <div class="body_wrap">
                                                ...
                                                <li class="menu-item menu-item-has-children">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="menu-item menu-item-has-children">
                                                            ...
                                                            <ul class="sub-menu">
                                                                <li class="menu-item">
                                                                    <a href="category-portfolio-2-columns.html">Portfolio 2 Columns</a>
                                                                </li>
                                                                <li class="menu-item">
                                                                    <a href="category-portfolio-3-columns.html">Portfolio 3 Columns</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="menu-item">
                                                            <a href="category-post-formats.html">Post Formats</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="menu-item menu-item-has-children">
            ...
            <div class="page_content_wrap page_paddings_yes">
                <div class="content_wrap">
                    <div class="content">
                        <div class="bp_group type-bp_group itemscope post_item post_item_single post_featured_default post_format_standard">
                                        ...
                                        <div id="cover-image-container">
                                            ...
                                            <div id="item-header-cover-image">
                                                <div id="item-header-avatar">
                                                    <a href="#" title="Power of Education">
                                                        <img src="http://placehold.it/154x154" class="avatar group-2-avatar avatar-150 photo" alt="Group logo of Power of Education" title="Power of Education">
                                                    </a>
                                                </div>
                                                <div id="item-header-content">
                                                    ...
                                                    <div id="item-meta">
                                                        ...
                                                        <p>Aenean diam orci, blandit sit amet porta et, pellentesque id magna. Mauris iaculis, purus eu maximus scelerisque, ante velit accumsan eros, a luctus tellus turpis ac justo. Mauris dui lorem, fringilla in consectetur eu, venenatis non odio. Vestibulum aliquet suscipit turpis. Quisque vel purus nec sem sollicitudin fermentum non et metus. Fusce non dui tellus.</p>
                                                    </div>
                                                </div>
                                                <div id="item-actions">
                                                    <h3>Group Admins</h3>
                                                    <ul id="group-admins">
                                                        <li>
                                                            <a href="#">
                                                                <img src="http://placehold.it/30x30" class="avatar user-1-avatar avatar-50 photo" alt="Profile picture of John Doe">
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <div id="item-body">
                                        ...
                                        <div class="activity single-group">
                                            <ul id="activity-stream" class="activity-list item-list">
                                                <!-- groups -->
                                                <li class="groups activity_update activity-item has-comments date-recorded-1461931257" id="activity-4">
                                                    <div class="activity-avatar">
                                                        <a href="#">
                                                            <img src="http://placehold.it/50x50" class="avatar user-1-avatar avatar-50 photo" alt="Profile picture of John Doe">
                                                        </a>
                                                    </div>
                                                    <div class="activity-content">
                                                        <div class="activity-header">
                                                            <p>
                                                                <a href="#" title="TRX_admin">
                                                                    TRX_admin
                                                                </a> posted an update in the group
                                                                <a href="#" class="">
                                                                    <img src="http://placehold.it/20x20" class="avatar22 avatar group-2-avatar avatar-20 photo" alt="Group logo of Power of Education">
                                                                </a>
                                                                <a href="#">Power of Education</a> 
                                                                <a href="#" class="view activity-time-since" title="View Discussion">
                                                                    <span class="time-since">7 months, 1 week ago</span>
                                                                </a>
                                                            </p>
                                                        </div>
                                                        ...
                                                        <ul>
                                                            <li id="acomment-5">
                                                                <div class="acomment-avatar">
                                                                    <a href="#">
                                                                        <img src="http://placehold.it/20x20" class="avatar user-1-avatar avatar-50 photo" alt="Profile picture of John Doe"> </a>
                                                                </div>
                                                                <div class="acomment-meta">
                                                                    <a href="#">John Doe</a> replied 
                                                                    <a href="#" class="activity-time-since">
                                                                        <span class="time-since">7 months, 1 week ago</span>
                                                                    </a> 
                                                                </div>
                                                                <div class="acomment-content">
                                                                    <p>Vestibulum aliquet suscipit turpis</p>
                                                                </div>
                                                            ...
                                                            <li id="acomment-6">
                                                                <div class="acomment-avatar">
                                                                    <a href="#">
                                                                        <img src="http://placehold.it/20x20" class="avatar user-1-avatar avatar-50 photo" alt="Profile picture of John Doe"> 
                                                                    </a>
                                                                </div>
                                                                <div class="acomment-meta">
                                                                    <a href="#">
                                                                ...
                                                                <div class="acomment-content">
                                                                    <p>
                                                                        Fusce pellentesque dui quis lorem gravida tristique. Sed efficitur efficitur dolor sit amet ultrices. Aenean diam orci, blandit sit amet porta et, pellentesque id magna. Mauris iaculis, purus eu maximus scelerisque, ante velit accumsan eros, a luctus tellus turpis ac justo. Mauris dui lorem, fringilla in consectetur eu, venenatis non odio.…
                                                                        <span class="activity-read-more" id="acomment-read-more-6">
                                                                            <a href="#" rel="nofollow">[Read more]</a>
                                                                        </span>
                                                                    </p>
                                                                </div>
                                                                <div class="acomment-options"></div>
                                                ...
                                                <!-- groups -->
                                                <li class="groups created_group activity-item mini date-recorded-1461931175" id="activity-3">
                                                    <div class="activity-avatar">
                                                        <a href="#">
                                                            <img src="http://placehold.it/20x20" class="avatar user-1-avatar avatar-50 photo" alt="Profile picture of John Doe">
                                                        </a>
                                                    ...
                                                    <div class="activity-content">
                                                        <div class="activity-header">
                                                            <p>
                                                                ...
                                                                created the group
                                                                <a href="#" class="">
                                                                    <img src="http://placehold.it/50x50" class="avatar group-2-avatar avatar-20 photo" alt="Group logo of Power of Education">
                                                                </a>
                                                                <a href="#">Power of Education</a> 
                                                                <a href="#" class="view activity-time-since" title="View Discussion">
                                                                    <span class="time-since">7 months, 1 week ago</span>
                                            ...
                                            <form action="#" name="activity-loop-form" id="activity-loop-form" method="post">
                                                <input type="hidden" id="_wpnonce_activity_filter" name="_wpnonce_activity_filter" value="99589658cd">
                                                <input type="hidden" name="_wp_http_referer" value="/groups/power-of-education/">
                                            </form>
                                            <!-- /form -->
                                        </div>
                                        <!-- /single-group -->
        ...
        <!-- All Script -->       
            ...
            <script type='text/javascript' src='js/bbpress/js/editor.min.js'></script> 
        <!-- /All Script -->                 
    </body>
</html>